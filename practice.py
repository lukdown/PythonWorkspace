...
# 월 4회 스터디를 하는데 3번은 온라인으로 하고 1 번은 오프라인으로 하기로 했습니다.
...
# \\ : 문장 내에서 \
# print("D:\\Python\\PythonWorkspace>")
...
# Quiz) 당신의 학교에서는 파이썬 코딩 대회를 조최합니다.
...
#     time = randrange(5, 51) # 5분 ~ 50분 thdy tlrks
...
# Quiz) 주어진 코드를 활용 하여 부동산 프로그램을 작성하시오.
